...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden px-4 py-12 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      >
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-blue-500/30 bg-blue-950/40 text-blue-400 text-xs font-medium backdrop-blur-md shadow-lg shadow-blue-950/50">
          ...
          <span>Phase 1 Setup Complete • Dark Mode Activated</span>
        </div>
      </motion.div>
      ...
      >
        <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight">
          Agentic Commerce <br />
          <span className="gradient-text">Powered by Prava SDK</span>
        </h1>
        <p className="text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed">
          High-performance autonomous commerce stack built with Next.js App Router, 
          Tailwind CSS, shadcn/ui components, and SQLite via Prisma.
        </p>
      </motion.div>
        ...
        >
          <Card className="glass-card glass-card-hover h-full">
            <CardHeader>
              ...
              <CardDescription>App Router foundation with full type safety and server component optimization.</CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-2 text-xs text-slate-300">
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-400" /> Next.js 14 App Router</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-400" /> TypeScript Strict Mode</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-400" /> Fast Refresh & Server Actions</li>
              </ul>
            </CardContent>
          </Card>
        </motion.div>
        ...
        >
          <Card className="glass-card glass-card-hover h-full">
            <CardHeader>
              ...
              <CardTitle>shadcn/ui & Animations</CardTitle>
              <CardDescription>Custom dark mode styling with Framer Motion, Lucide icons, and Sonner toasts.</CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-2 text-xs text-slate-300">
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-400" /> Tailwind CSS + Variables</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-400" /> Framer Motion Micro-effects</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-400" /> Sonner Toast System</li>
              </ul>
            </CardContent>
          </Card>
        </motion.div>
        ...
        >
          <Card className="glass-card glass-card-hover h-full">
            <CardHeader>
              ...
              <CardTitle>Prava SDK & SQLite</CardTitle>
              <CardDescription>Database persistence via Prisma with Prava payment skill integration ready.</CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-2 text-xs text-slate-300">
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-400" /> SQLite (dev.db)</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-400" /> Prisma ORM Client</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-400" /> Prava SDK Integration Skill</li>
              </ul>
            </CardContent>
          </Card>
        </motion.div>
      ...
      <div className="mt-16 text-center text-xs text-slate-500 border-t border-slate-800/60 pt-6">
        Agentic Commerce Hackathon • Phase 1 Foundation Active
      </div>
    </div>
  );
}
